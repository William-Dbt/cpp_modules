...
int	main() {
	...
	// Uncomment the line below and it'll not compile
	// const Animal	abstract;
	...
	if (dog->getBrain()) {
		...
		dog->getBrain()->setIdea(0, "Buy another phone");
		dog->getBrain()->setIdea(1, "Start gym");
		dog->getBrain()->setIdea(2, "Repair the TV instead of buying one");
	...
	if (cat->getBrain()) {
		...
		cat->getBrain()->setIdea(0, "Idea old cat 0");
